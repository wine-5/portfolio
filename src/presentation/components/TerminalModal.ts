      ...
      <div class="terminal-modal__window">
        ...
        <div class="terminal-modal__body">
          ...
          <div class="terminal-modal__input-line">
            ...
            <input type="text" class="terminal-modal__input" id="terminal-input" spellcheck="false" autocomplete="off" aria-label="Command input" />
          </div>
        </div>
      </div>
    `;
